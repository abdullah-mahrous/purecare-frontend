...
function VideoContainer({
  ...
  const bubbleConfig = [
    ...
    { style: "top-[-4px] right-5 size-3 z-[-1] opacity-50", color: "#2DBE73", delay: 0.4, duration: 5.5 },
    { style: "top-[-20px] right-10 size-4 z-[-1] opacity-80", color: "#FBBF24", delay: 0.8, duration: 6 },

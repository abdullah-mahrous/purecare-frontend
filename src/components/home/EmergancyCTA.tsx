                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="min-w-0 flex-col items-end text-right sm:items-start">
                        ...
                        <div className="mt-5 flex flex-wrap gap-3 flex-col">
                            <BaseBtn className="gap-2 bg-emergancy text-white" onClick={() => window.location.href = `tel:${contacts.emergencyNumber}`}>
                            ...
                            <BaseBtn className="gap-2 border border-emergancy text-emergancy" onClick={() => window.open(contacts.whatsappUrl(contacts.whatsappNumber, inquiryMessage), "_blank")}>
